...
var require_logo = __commonJS({
  "src/assets/logo.jpeg"(exports, module) {
    module.exports = "/assets/logo.b9b4fb0e.jpeg";
  }
});
...
var import_logo = __toESM(require_logo());
...
//# sourceMappingURL=pages-DAUUCY5M.mjs.map
